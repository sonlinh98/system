...
/**
 * Servlet implementation class PGView
 */
@WebServlet(name = "pgview", urlPatterns = { "/pg/view" })
public class PGView extends HttpServlet {
	...
	private void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Xác định kiểu dữ liệu trả về trình khách
		...
		PGControl pgc = new PGControl(cp);
		...
		// Lấy giao diện html
		String view = pgc.viewPGs(null, (short)1, (byte)10);
		
		// trả lại kết nối
		pgc.releaseConnection();
		
		
		// Tạo trang giao diện trả về
